...
// 'karafun' (needs karafunEnabled + broadcaster/admin), 'karaoke' (needs
// karaokeEnabled, every role) and 'broadcasters' (master admin only) are
// conditionally appended by the page, not listed here — matching the real
// access rules in dashboard/page.js rather than the design mockup's guess.
