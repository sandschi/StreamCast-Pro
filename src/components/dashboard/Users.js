                    ...
                    <div key={u.id} className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-5 hover:border-zinc-700 transition-all group">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            ...
                            <button
                                ...
                                className={`py-2 px-1 rounded-xl text-[10px] font-bold uppercase tracking-tighter transition-all border ${u.role === 'mod' ? 'bg-primary-600 text-white border-primary-600 shadow-lg shadow-primary-600/20' : 'text-zinc-400 border-zinc-800 hover:border-primary-500/50'}`}
                            >
                                Mod
                            </button>
                            <button
